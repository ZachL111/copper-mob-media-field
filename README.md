...
copper-mob-media-field is a Go project for mobile workflows. It focuses on this technical goal: Create a Go reference implementation for media workflows, centered on policy evaluation, deny and allow fixtures, and explainable decision traces.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 173, risk penalty 6, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
