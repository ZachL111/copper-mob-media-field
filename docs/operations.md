...
`copper-mob-media-field` is centered on mobile workflows work in Go. The technical target is: Create a Go reference implementation for media workflows, centered on policy evaluation, deny and allow fixtures, and explainable decision traces.
...
The score is deterministic. The current threshold is 173. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 4.
