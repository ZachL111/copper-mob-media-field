"""Regression checks for the copper-mob-media-field casebook."""
...
from casebook.harness import assert_expected, copper_mob_media_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_mob_media_field_summary(), assert_expected())
